  ...
  "1": {
    ...
    process: `<ol class='level-one'>
                <li class='level-two'>
                    Research and Benchmarking
                    <ol style="list-style-type: lower-alpha;">
                        <li>Interviewed individuals who frequently organize birthdays, weddings, and corporate events to uncover planning frustrations.</li>
                        <li>Benchmarked tools like Facebook Events, Eventbrite, and Instagram for vendor engagement and discovery patterns.</li>
                        <li>Identified common user frustrations such as difficulty finding trusted vendors, unclear pricing, and repetitive manual coordination.</li>
                    </ol>
                </li>
                <li class='level-two'>
                    Information Architecture
                    <ol style="list-style-type: lower-alpha;">
                        <li>Defined three primary user journeys: browsing vendors, booking events, and managing communications.</li>
                        <li>Mapped user flow from event creation → vendor discovery → booking confirmation → chat → post-event feedback.</li>
                        <li>Outlined content structure for the MVP: Home, Vendors, My Events, Messages, and Profile.</li>
                    </ol>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ol style="list-style-type: lower-alpha;">
                        <li>Exploring a lively yet professional color palette inspired by event themes (e.g., soft pastels and gradients).</li>
                        <li>Evaluating iconography and typography that communicate approachability and celebration without overwhelming users.</li>
                        <li>Planning for vendor feed UI inspired by social platforms for discovery and engagement.</li>
                    </ol>
                </li>
                <li>
                    Next Steps
                    <ol style="list-style-type: lower-alpha;">
                        <li>Conduct usability testing on wireframes to validate navigation clarity and information hierarchy.</li>
                        <li>Iterate on UI based on feedback, focusing on simplifying booking and vendor comparison flows.</li>
                        <li>Start building MVP using Vue.js and Firebase for booking, chat, and vendor management features.</li>
                    </ol>
                </li>
                </ol>`,
    gallery: "[]",
    ...
    challenge: `<p>The challenge was to design a trustworthy and user-friendly interface for a Web3 product. Blockchain apps often intimidate users with
                technical jargon, so our goal was to make the experience as simple and transparent as a traditional web app—while maintaining the integrity
                of blockchain functionality.</p>`,
    process: `<ol class='level-one'>
                <li class='level-two'>
                    Research and Discovery
                    <ol style="list-style-type: lower-alpha;">
                        <li>Studied existing crowdfunding platforms like Kickstarter, StartEngine, and Indiegogo to understand user expectations.</li>
                        <li>Analyzed Web3 products to identify usability pain points—complex onboarding, unclear wallet processes, and technical terminology.</li>
                        <li>Defined three user groups: project creators, admins, and investors, each with unique motivations and pain points.</li>
                    </ol>
                </li>
                <li class='level-two'>
                    Information Architecture
                ...
                <li>
                    Wireframing and UI Design
                    <ol style="list-style-type: lower-alpha;">
                        <li>Designed wireframes focusing on ease of use and reducing technical intimidation.</li>
                        <li>Used Figma to create a clean, professional interface emphasizing data visibility and trust signals.</li>
                        <li>Incorporated subtle blockchain-themed visual cues without overwhelming users.</li>
                    </ol>
                </li>
                <li>
                    Development
                    <ol style="list-style-type: lower-alpha;">
                        <li>Built the frontend in Vue.js for efficient state management and modularity.</li>
                        <li>Collaborated closely with backend developers for smart contract testing and transaction validation.</li>
                    </ol>
                </li>
                <li>
                    Solution
                    <ol style="list-style-type: lower-alpha;">
                        <li>Simple onboarding with integrated wallet connection.</li>
                        <li>Transparent investment dashboard showing project portfolio, share percentages, and project milestones.</li>
                    </ol>
                </li>
                <li>
                    The Impact
                ...
                <li>
                    ...
                    <ol style="list-style-type: lower-alpha;">
                        <li>
                            What worked well:
                            <ol style="list-style-type: lower-roman;">
                                <li>Human-centered design approach helped simplify the intimidating Web3 experience.</li>
                                <li>Collaborative workflow between design and development ensured consistent experience across user types.</li>
                            </ol>
                        </li>
                    <li>
                        What I would improve:
                        <ol style="list-style-type: lower-roman;">
                            <li>Add educational onboarding to guide first-time crypto users.</li>
                            <li>Add analytics for project performance and investment trends.</li>
                        </ol>
                    </li>
                    </ol>
                </li>
